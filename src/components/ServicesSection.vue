<template>
  <section id="servicios" class="bg-white section-padding">
    <div class="container-custom">
      ...
      <div v-if="selectedService && !isMobile" class="rounded-2xl p-8 transition-all duration-300" style="background-color: #F9F7F4;">
          ...
          <div class="bg-white rounded-xl p-6 shadow-lg">
            <div class="text-center">
              <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4" style="background-color: #F5E9DA;">
                <!-- Iconos aquí (los mismos que en ServiceCard) -->
                <svg v-if="selectedService.icon === 'BuildingIcon'" class="w-8 h-8" style="color: #8D5524;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                </svg>
                <svg v-else-if="selectedService.icon === 'HomeIcon'" class="w-8 h-8" style="color: #8D5524;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <svg v-else-if="selectedService.icon === 'SparklesIcon'" class="w-8 h-8" style="color: #8D5524;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
