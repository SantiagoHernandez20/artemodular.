...
router.get('/stream', apiKeyAuth, async (req, res) => {
...
router.put('/:id/reject', apiKeyAuth, TestimonialController.rejectTestimonial);

// DELETE /api/testimonials/:id - Eliminar testimonio (requiere IP verificada)
router.delete('/:id', apiKeyAuth, TestimonialController.deleteTestimonial);
